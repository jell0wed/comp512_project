...
public class FlightTestSuite extends TestSuite {
    ...
    public void testAddQueryFlight() throws IOException, ClassNotFoundException {
        ...
        BaseTCPResponse resp = TestUtils.send(addFlightReq);
        ...
        BaseTCPResponse respQty = TestUtils.send(queryFlightQtyReq);
    ...
    public void testDeleteFlight() throws IOException, ClassNotFoundException {
        ...
        BaseTCPResponse delResp = TestUtils.send(delFlightReq);
        ...
        BaseTCPResponse flightResp = TestUtils.send(queryFlightReq);
    ...
    public void testQueryFlightPrice() throws IOException, ClassNotFoundException {
        ...
        BaseTCPResponse priceResp = TestUtils.send(flightPriceReq);
    ...
    public void testReserveFlight() throws IOException, ClassNotFoundException {
        ...
        BaseTCPResponse reserveFlightResp = TestUtils.send(reserveFlightReq);
        ...
        BaseTCPResponse queryFlightSeatsResp = TestUtils.send(queryFlightSeatsReq);
